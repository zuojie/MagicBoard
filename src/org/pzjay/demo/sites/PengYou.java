...
public class PengYou extends SiteActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        logOut = false;
        wv = (WebView) findViewById(R.id.WebviewPengYou);
        MainActivity.setWebView(wv, this);
        MainActivity.mWebView.loadUrl(MyData.PENGYOU);
    }
    
    @Override
	protected void onResume() {
        MainActivity.setWebView(wv, this);
        MainActivity.progressBar = (ProgressBar) findViewById(R.id.pb_pengyou);
		super.onResume();
	}
}
